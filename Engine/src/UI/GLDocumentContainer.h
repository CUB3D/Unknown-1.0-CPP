...
#ifndef HTMLGL_GLDOCUMENTCONTAINER_H
#define HTMLGL_GLDOCUMENTCONTAINER_H

#include <litehtml.h>

namespace litehtml
{
    class glDocumentContainer : public document_container
    {
    public:
        virtual uint_ptr
        create_font(const tchar_t *faceName, int size, int weight, font_style italic, unsigned int decoration,
        ...
        virtual void draw_text(uint_ptr hdc, const tchar_t *text, uint_ptr hFont, litehtml::web_color color,
...
#endif //HTMLGL_GLDOCUMENTCONTAINER_H
